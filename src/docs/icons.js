...
export const Hamburger = ({ color = null }) => (
  <svg viewBox="0 0 32 32" height="1em" width="1em" style={{ color }}>
...
export const Github = ({ color = null }) => (
  <svg width="1em" height="1em" style={{ display: 'inline-block', color }} viewBox="0 0 24 24">
